...
function SignUp() {
  ...
  const showToast = (msg) => {
    ...
    setTimeout(() => setToastVisible(true), 10)       // trigger slide-in
    setTimeout(() => setToastVisible(false), 2600)    // start fade-out
    setTimeout(() => setToast(null), 3000)            // remove from DOM
  }
    ...
    <div className='w-full min-h-screen bg-zinc-950 flex'>
      ...
      <div className='w-full lg:w-[55%] bg-zinc-950 lg:bg-zinc-900 flex flex-col justify-center px-8 md:px-16 py-10 overflow-y-auto'>
        ...
        <div className='flex items-center gap-4 mb-8'>
          ...
          >
            {frontendImage ? (
              <img src={frontendImage} className='w-full h-full object-cover' alt='profile' />
            ) : (
          ...
          <div>
            ...
            <p className='text-zinc-400 text-sm'>
              {frontendImage ? 'Looking good! Fill in your details' : 'Create your account to get started'}
            </p>
          </div>
        </div>
