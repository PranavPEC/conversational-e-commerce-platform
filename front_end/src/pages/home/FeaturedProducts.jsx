                    ...
                    <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                        {featured.map(product => (
                            <div
                                ...
                                className='group bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden cursor-pointer flex flex-col transition-all duration-300 ease-out hover:-translate-y-1.5 hover:border-emerald-500 hover:shadow-2xl hover:shadow-emerald-500/20'
                            >
                                {/* Image */}
